    ...
    authedClient
      ...
      .then((data) => {
        ...
        const request = https.get(
          `https://min-api.cryptocompare.com/data/pricemulti?fsyms=${tempCurrencies}&tsyms=USD&api_key=8a4db04554e090369b7d5a2efee990458811ff29b59da6176beb6450247cd5bb`,
          (res) => {
            res.on("data", (d) => {
              temp += d;
